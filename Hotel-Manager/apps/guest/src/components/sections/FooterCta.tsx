...
export default function FooterCta() {
  return (
    <section className="relative flex min-h-[68vh] items-center">
      {/* soft cream scrim settles the closing line over the wave terrain */}
      ...
      <div className="container-x relative w-full py-28 text-center">
        <Reveal className="mx-auto max-w-2xl">
          <p className="eyebrow mb-5">{footer.closingEyebrow}</p>
          <h2 className="font-serif text-[clamp(2.4rem,6vw,4.6rem)] font-medium leading-[1.05] text-ink">
            {footer.closingTitle}
          </h2>
